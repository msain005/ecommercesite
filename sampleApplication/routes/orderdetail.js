...
// URL: http://localhost:3000/orderdetail/1/show
// ==================================================
...
// URL: http://localhost:3000/orderdetail/addrecord
// ==================================================
...
router.post('/', function(req, res, next) {
    ...
    db.query(insertquery,[req.body.order_id, req.body.product_id, req.body.saleprice, req.body.paymentstatus],(err, result) => {
        if (err) {
            console.log(err);
            res.render('error');
        } 
...
// URL: http://localhost:3000/orderdetail/1/edit
// ==================================================
...
// URL: http://localhost:3000/orderdetail/save
// ==================================================
...
// URL: http://localhost:3000/orderdetail/1/delete
// ==================================================
